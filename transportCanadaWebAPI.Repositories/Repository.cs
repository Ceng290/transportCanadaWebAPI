...
namespace TransCanadaWebAPI.Repositories
{
    public abstract class Repository<T> where T : class
    {
        ...
        public Repository()
        {
            ConnectionString = ConfigurationManager.ConnectionStrings["TransportCanada"].ConnectionString;
        }
        ...
        protected virtual IDataReader ExecuteReader(string commandText, SqlParameter[] parameters = null, CommandType commandType = CommandType.Text, SqlConnection connection = null)
        {
        ...
        protected virtual int ExecuteNonQuery(string commandText, SqlParameter[] parameters = null, CommandType commandType = CommandType.Text, SqlConnection connection = null, SqlTransaction transaction = null)
        {
        ...
        protected virtual object ExecuteScalar(string commandText, SqlParameter[] parameters = null, CommandType commandType = CommandType.Text, SqlConnection connection = null, SqlTransaction transaction = null)
        {
            bool isLocalConnection = false;
            try
            {
        ...
        private SqlCommand BuildSqlCommand(string commandText, SqlParameter[] parameters, CommandType commandType, ref SqlConnection connection, SqlTransaction transaction, ref bool isLocalConnection)
        {
        ...
        //end Database command execution methods
    }
}